                                ...
                                <ul className="list-group no-border">
                                    <li className="list-group-item">
                                        ...
                                        <div className="clear">
                                            ...
                                            <span className="text-muted">新系统终于上线了！</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <span className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <span className="block">Larissa</span>
                                            <span className="text-muted">终于~~</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <span className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <span className="block">Harriet</span>
                                            <span className="text-muted">是啊，等了好久了。。。！</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <span className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <span className="block">Randy</span>
                                            <span className="text-muted">那个图表。。。那个。。。我。。我最喜欢了..</span>
                                        </div>
                                    </li>
                                </ul>
                            </Card>
